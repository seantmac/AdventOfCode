...
if __name__ == '__main__':
    ...
    input_list = ['north', 'take sand', 'north', 'take space heater', 'east', 'take semiconductor', 'west', 'south', 'south',
     'east', 'take ornament', 'east', 'west', 'south', 'take festive hat', 'east', 'take asterisk', 'west', 'north', 'west',
     'west', 'north', 'north']


    '''
    'north', 'take sand', 'north', 'take space heater', 'east', 'take semiconductor', 'west', 'south', 'south',
     'east', 'take ornament', 'east', 'west', 'south', 'take festive hat', 'east', 'take asterisk', 'west', 'north', 'west', 
     'west', 'north', 'north', 'inv'
     '''
#go get sand, space heater, semiconductor and return to start:  'north', 'take sand', 'north', 'take space heater', 'east', 'take semiconductor', 'west', 'south', 'south',
#got get ornament, festive hat, asterisk and return to start:  'east', 'take ornament', 'east', 'west', 'south', 'take festive hat', 'east', 'take asterisk', 'west', 'north', 'west',
#to get to the security check point:  'west', 'north', 'north'
#
#

    '''
    ['north', 'take sand', 'north', 'take space heater', 'east', 'take semiconductor', 'west', 'south', 'south', 
     'east', 'take ornament', 'east', 'west', 'south', 'take festive hat', 'east', 'take asterisk', 'west', 'north', 
     'west', 'west', 'north', 'north', 'inv']    
    '''
#last move pulled out before inv:  'west',, 'inv'

    #'east', 'west', 'take festive hat', 'take ornament', 'inv', 'take semiconductor', 'inv', 'east', 'west', 'west', 'west'


    # The item list you've gathered
    # This was my list, check carefully for your items
    item_list = ['asterisk', 'ornament', 'space heater', 'festive hat', 'semiconductor', 'sand']
    ...
    if input_list:
        ...
        for combination in range(2 ** len(item_list)):
            ...
            input_list.append('west')  #west is last move thru security
            for item in take_list:
                input_list.append('drop ' + item)
    else:
